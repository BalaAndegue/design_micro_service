...
import { fetchStats, fetchProducts, createProduct, patchProduct, deleteProduct, Product } from '@/lib/api/products';
...
type ActiveSection = 'dashboard' | 'products' | 'users' | 'orders' | 'settings';
